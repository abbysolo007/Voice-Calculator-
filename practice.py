...
def light():
    ...
    voice_button.config(bg=parent_window.cget('background'), fg='green')

def dark():
    parent_window.config(background='black')
    ThemedStyle(parent_window).set_theme('black')
    label1.config(bg=parent_window.cget('background'), fg='green')
    label2.config(bg=parent_window.cget('background'), fg='green')
    tap_label.config(bg=parent_window.cget('background'), fg='green')
    voice_button.config(bg=parent_window.cget('background'), fg='green')
...
mic = PhotoImage(file='F:/NOtes/Mini Project/mic.png')

voice_button = Button(parent_window, command=voice_thread, image=mic, borderwidth=0, width='50', height='50' )

tap_label = Label(parent_window, text='Tap To Speak', font=("Helvetica", 20, 'bold'), justify='left')
